  ...
  return (
    <section className=" ">
      ...
      <section className=" grid gap-4 text-xl sm:grid-cols-two">
        <article className="grid grid-cols-2 justify-items-center items-center bg-slate-300/50 text-2xl rounded-3xl  py-2 sm:px-2">
        ...
        <article className="grid grid-cols-3 py-3 bg-slate-300/50 text-2xl rounded-3xl sm:grid-cols-1 sm:px-2 sm:py-0 ">
